...
use super::state::NewFolderDialogState;

/// 渲染新建文件夹对话框覆盖层
pub fn render_new_folder_dialog_overlay<F>(
    state: Entity<NewFolderDialogState>,
    on_create: F,
    cx: &App,
) -> impl IntoElement
where
            ...
            div()
                ...
                .child(
                    div()
                        ...
                        .child(i18n::t(&lang, "sftp.new_folder.title")),
                )
                // 文件夹名称输入
                .child(
                    div()
                        ...
                        .child(
                            div()
                                ...
                                .child(i18n::t(&lang, "sftp.new_folder.name")),
                        )
